...
Before the first workshop, please make sure that you have access to R and RStudio on your laptop. If you need help with the installation, please follow [this tutorial](../../../tutorials/r_install.qmd).
...
# [Introduction to R](basics/intro.qmd)

# Data analysis workflow

## [Finding and importing data](basics/import.qmd)

## [Data wrangling with `dplyr`](basics/clean.qmd)

## Exploratory analysis

### [Summary statistics](basics/summary.qmd)

### [Data visualization with `ggplot2`](basics/ggplot.qmd)

## [Hypothesis testing / modelling](basics/tests.qmd)

# Other resources

-   [Data Center collection of resources](../../../tutorials/links.qmd)
