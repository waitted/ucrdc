...
In the following, we'll work with some example data of student characteristics and grades. You can import the data from a CSV file with the following code:
...
For any aesthetic you specify, you can override the default behavior by adding `scale_...` elements, referring to the relevant aesthetic. You can manually specify legend titles, color palettes, labels, etc.
